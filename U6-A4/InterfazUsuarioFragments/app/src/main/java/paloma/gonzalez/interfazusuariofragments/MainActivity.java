...
public class MainActivity extends AppCompatActivity
        implements MensualFragment.OnSemanaCambiada{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView menuPrincipalListView=findViewById
                (R.id.menuListViewPrincipal);
                                    ...
                                    switch (item.getItemId()) {
                                        case R.id.actionInicio:
                                            ...
                                            getSupportFragmentManager().beginTransaction().
                                                    replace
                                                            (R.id.contenedorPrincipal,fragmentInicio).
                                                    addToBackStack
                                                            (null).
                                                    commit();
                                            break;
                                        case R.id.actionMensual:
                                            ...
                                            getSupportFragmentManager().beginTransaction().
                                                    replace
                                                            (R.id.contenedorPrincipal,fragmentMensual).
                                                    addToBackStack
                                                            (null).
                                                    commit();
                                            break;
                                        case R.id.actionSemanal:
                                            ...
                                            getSupportFragmentManager().beginTransaction().
                                                    replace
                                                            (R.id.contenedorPrincipal,fragmentSemana).
                                                    addToBackStack
                                                            (null).
                                                    commit();
                                            break;
