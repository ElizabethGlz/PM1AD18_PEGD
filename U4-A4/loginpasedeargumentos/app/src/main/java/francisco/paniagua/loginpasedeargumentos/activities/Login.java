...
public class Login extends Activity {
    EditText usuario,password,edad,estadoCivil,profesion;
    Button login;
    TextView titulo;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Usuario result = dao.usuarioExist(usuario.getText().toString(),password.getText().toString());
                ...
                if(result!=null){
                    existe=result;
                    existeU=true;
                    respuesta.putExtra("usuario",existe);
                }
                respuesta.putExtra("resultado",existeU);
